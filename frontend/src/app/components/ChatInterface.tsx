...
export function ChatInterface({ transcript, title, onNavigate }: ChatInterfaceProps) {
  ...
  const responses = [
    ...
    "According to the narrative, this was a formative experience that shaped the family's identity. The speaker included details about places, people, and moments that held special significance.",
  ];
