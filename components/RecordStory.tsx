...
interface RecordStoryProps {
  onNavigate: (screen: string, data?: any) => void;
  onStoryRecorded: (transcript: string, title: string) => void;
}

export function RecordStory({ onNavigate, onStoryRecorded }: RecordStoryProps) {
...
I'm telling you these stories because they're important. They're part of who we are, where we came from. And I want you to remember them, to pass them on to your children someday.`;
    ...
    onStoryRecorded(mockTranscript, mockTitle);
    onNavigate('transcript', { transcript: mockTranscript, title: mockTitle });
  };
